        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderTotal = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    GrossTotal = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order", x => x.PurchaseOrderID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticalNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: true),
                    OrdersPurchaseOrderID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderDetail_Order_OrdersPurchaseOrderID",
                        column: x => x.OrdersPurchaseOrderID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetail_OrdersPurchaseOrderID",
                table: "OrderDetail",
                column: "OrdersPurchaseOrderID");
